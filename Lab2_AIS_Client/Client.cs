...
class Client
{
        ...
        while (true)
        {
            ...
            if (key.Key == ConsoleKey.D1)
            {
                ...
                try
                {
                    for (int i = 0; i < (strings.Length - 1); i++)
                    {
                        ...
                        Console.WriteLine($"| {i + 1,-5} | {car.Maker,-15} | {car.Model,-10} | {car.Color,-10} | {car.VIN,-20} | {car.Price,-15} | {car.YearProd,-15} | {car.Mileage,-15} | {car.IsSold,-15} | {car.HasAccidents,-10} |");
                        Console.WriteLine(sep);
                    }
                }
                catch (Exception ex)
            ...
            else if (key.Key == ConsoleKey.D2)
            {
                ...
                try
                {
                    ...
                    Console.WriteLine($"| {num_str,-5} | {car.Maker,-15} | {car.Model,-10} | {car.Color,-10} | {car.VIN,-20} | {car.Price,-15} | {car.YearProd,-15} | {car.Mileage,-15} | {car.IsSold,-15} | {car.HasAccidents,-10} |");
                    Console.WriteLine(sep);
                }
                catch (Exception ex)
                {
    ...
    public static string AddRecordToFile()
    {
        ...
        {
            Console.Clear();
            Console.WriteLine("Введите название марки производителя автомобиля: ");
        ...
        {
            Console.Clear();
            Console.WriteLine("Введите VIN автомобиля: ");
        ...
        while (car.YearProd <= 0 || car.YearProd == null)
        {
            Console.Clear();
